error id: file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/models/Cart.scala:scala/None.
file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/models/Cart.scala
...
non-local guesses:
	 ...
	 -scala/Predef.None().
offset: 612
uri: file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/models/Cart.scala
text:
```scala
package models
...
object CartRepo {
  ...
  def addOrUpdate(userId: Long, mediaId: Long, quantity: Int): Either[String, CartItem] = {
    ...
    MediaRepo.find(mediaId) match {
      case No@@ne => Left("Producto no encontrado")
      case Some(media) =>

error id: file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/models/User.scala:java/util/Base64#getEncoder().
file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/models/User.scala
empty definition using pc, found symbol in pc: java/util/Base64#getEncoder().
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -java/util/Base64.getEncoder.
	 -Base64.getEncoder.
	 -scala/Predef.Base64.getEncoder.
offset: 651
...
object UserRepo {
  ...
  private def hashPassword(password: String): String = {
    ...
    Base64.getEnco@@der.encodeToString(hash)
  }

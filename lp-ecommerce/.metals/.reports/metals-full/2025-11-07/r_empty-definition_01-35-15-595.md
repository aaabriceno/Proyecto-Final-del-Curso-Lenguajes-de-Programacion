error id: file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/http/HttpServer.scala:java/net/Socket#getOutputStream().
file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/http/HttpServer.scala
empty definition using pc, found symbol in pc: java/net/Socket#getOutputStream().
...
non-local guesses:
	 ...
	 -socket/getOutputStream#
	 -socket/getOutputStream().
	 -scala/Predef.socket.getOutputStream.
	 -scala/Predef.socket.getOutputStream#
	 -scala/Predef.socket.getOutputStream().
offset: 2557
...
object HttpServer {
  ...
  private def handleClient(socket: Socket): Unit = {
    ...
    try {
      ...
      val writer = new BufferedWriter(new OutputStreamWriter(socket.getOu@@tputStream, "UTF-8"))

error id: file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/controllers/AuthController.scala:getOrElse.
...
object AuthController {
  ...
  def register(request: HttpRequest): HttpResponse = {
    ...
    val password = data.g@@etOrElse("password", "")

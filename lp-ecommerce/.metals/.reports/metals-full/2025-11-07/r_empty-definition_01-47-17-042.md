error id: file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/models/Category.scala:scala/collection/StrictOptimizedIterableOps#filterNot().
file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/models/Category.scala
empty definition using pc, found symbol in pc: scala/collection/StrictOptimizedIterableOps#filterNot().
...
non-local guesses:
	 ...
	 -data/filterNot#
	 -data/filterNot().
	 -scala/Predef.data.filterNot.
	 -scala/Predef.data.filterNot#
	 -scala/Predef.data.filterNot().
offset: 5017
uri: file:///C:/Users/PC/Proyecto-Final-del-Curso-Lenguajes-de-Programacion/lp-ecommerce/app/models/Category.scala
text:
```scala
package models
...
object CategoryRepo {
  ...
  def update(id: Long, name: String, parentId: Option[Long], description: String): Option[Category] = {
    ...
    data.find(_.id == id).map { oldCategory =>
      ...
      data = data.filterN@@ot(_.id == id) :+ updated
      updated
    }
  }
